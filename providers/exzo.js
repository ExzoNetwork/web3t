...
(function(){
  var Wallet, ExzoCrypto, ref$, map, foldl, filter, get, post, plus, minus, times, div, fromHex, bip39, bigInteger, moment, toCallback, calcFee, getKeys, getTransactions, bigInt, getUnspents, createTransaction, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, tryParseAmount, getBalance, getMarketHistoryPrices, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString;
  Wallet = require('../node_modules_embed/xzo-wallet/Crypto/Wallet.js')['default'];
  ExzoCrypto = require('../node_modules_embed/xzo-wallet/Crypto/index.js')['default'];
  ...
  out$.getKeys = getKeys = function(arg$, cb){
    ...
    return toCallback(ExzoCrypto.init(), function(err, vc){
  ...
  out$.createTransaction = createTransaction = curry$(function(arg$, cb){
    ...
    if (!Wallet.IsValidAddress(recipient)) {
      return cb("Recipient address is not valid Exzo address");
    }
    return getUnspents({
      network: network,
