...
(function(){
  ...
  out$.isValidAddress = isValidAddress = function(arg$, cb){
    ...
    if (!isValid) {
      return cb("Given address is not valid Exzo EVM address");
    }
    return cb(null, true);
  };
  ...
  out$.createTransaction = createTransaction = curry$(function(arg$, cb){
    ...
    if (!isAddress(recipient)) {
      return cb("Address is not correct Exzo EVM address");
    }
