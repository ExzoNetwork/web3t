...
(function(){
  var mainnet, testnet, type, enabled, token, nickname, walletIndex, name, color, image, usdInfo, out$ = typeof exports != 'undefined' && exports || this;
  out$.mainnet = mainnet = {
    decimals: 8,
    txFee: '0.0000004',
  ...
  out$.usdInfo = usdInfo = "url(https://explorer.exzo.com/ticker).usdt_price";
}).call(this);
