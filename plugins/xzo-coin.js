...
(function(){
  ...
  out$.mainnet = mainnet = {
    ...
    networks: {
      ...
      xzo_erc20: {
        id: "xzo_erc20",
        name: "Ethereum (XZO ERC20)",
        referTo: "xzo_erc20"
      },
      bsc_xzo: {
        id: "bsc_xzo",
        name: "Binance Smart Chain (XZO BEP20)",
        referTo: "bsc_xzo"
      },
      xzo_huobi: {
        id: "xzo_huobi",
        name: "Huobi ECO Chain (XZO HRC20)",
        referTo: "xzo_huobi"
      },
      xzo2: {
        id: "xzo2",
  ...
  out$.name = name = 'Exzo EVM';
  out$.token = token = 'xzo_evm';
  ...
  out$.usdInfo = usdInfo = "url(https://explorer.exzo.com/ticker).price_usd";
}).call(this);
